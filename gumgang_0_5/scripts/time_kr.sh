...
# Returns current KST time formatted for use in filenames (compact version)
# No hyphens in date/time parts
#
# Example:
#   format_for_filename_compact  # "20250809_1115"
format_for_filename_compact() {
    date "+%Y%m%d_%H%M"
}
